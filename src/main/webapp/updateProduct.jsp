...
<script 
	src="./resources/js/validation.js">
</script>
</head>
<body>
	...
	<div class="container">
		<div class="row">
			...
			%>
		<div class="col-md-5">
			<img alt="image" src="./upload/<%=rs.getString("p_productImage")%>" style="width: 100%;">
		</div>
		...
		<div class="col-md-7">
			<form action="./processUpdateProduct.jsp" method="post"
				...
				<div class="form-group row">
					...
					<div class="col-sm-3">
						<input type="text" name="unitPrice" id="unitPrice" value="<%=rs.getString("p_unitPrice")%>" class="form-control">
					</div>
				</div>
				<div class="form-group row">
				...
				<div class="form-group row">
					...
					<div class="col-sm-3">
						<input type="text" name="unitsInStock" id="unitsInStock" value="<%=rs.getString("p_unitsInStock")%>" class="form-control">
					</div>
				</div>
				<div class="form-group row">
				...
				<div class="form-group row">
					...
					<div class="col-sm-5">
						<input type="file" name="productImage" value="<%=rs.getString("p_productImage")%>" class="form-control">
					</div>
				</div>
				<div class="form-group row">
					<div class="col-sm-3">
